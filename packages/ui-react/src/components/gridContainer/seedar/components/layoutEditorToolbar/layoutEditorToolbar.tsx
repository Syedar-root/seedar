...
export const LayoutEditorToolbar: React.FC = () => {
  ...
  const helperText = activeBreakpointConfigured
    ...
    : state.activeBreakpointSource
      ? `${getBreakpointSummaryLabel(state.activeBreakpoint)} 还没有独立布局，当前正在参考 ${getBreakpointSummaryLabel(state.activeBreakpointSource)}。拖拽后会写入当前断点。`
          ...
          <div className={styles.segmented}>
            <button
              ...
              className={clsx(
                ...
                false && styles.segmentedButtonActive,
              )}
              onClick={() => undefined}
            >
              跟随容器
